  ...
  return (
    <>
      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-6 py-4 md:py-6 relative">
        ...
        <a
          href="https://www.linkedin.com/in/prof-osaren-emokpae-phd-dba-fbim-frpa-mcid-207b268/"
          target="_blank"
        ...
        >
          <img
            ...
            alt="LinkedIn"
            className="mr-10 hover:scale-125 transition-transform duration-300"
          />
        </a>
        ...
        <div
          className={`fixed top-0 left-0 h-full w-64 bg-[#0b1227]/80 backdrop-blur-md z-50 transform transition-transform duration-300 ease-in-out md:hidden ${menuOpen ? "translate-x-0" : "-translate-x-full"}`}
        >
          <button
            onClick={() => setMenuOpen(false)}
                ...
                <div key={index} className="min-w-full h-full">
                  {slide.hasText ? (
                    <div className="flex flex-col md:flex-row bg-[#0b1227] shadow-lg rounded-2xl overflow-hidden h-full">
                      ...
                      />
                      <div
                        className={`p-6 pb-8 md:p-12 md:relative md:-top-20 flex flex-col justify-center text-white ${index === 1 ? "md:w-2/5" : "md:w-1/2"}`}
                      >
      ...
      <div className="flex justify-center gap-3 md:gap-4 -mt-0 mb-6">
        {slides.map((_, index) => (
          <span
            ...
            className={`w-2 h-2 rounded-full cursor-pointer transition ${currentSlide === index ? "bg-white" : "bg-white/40"}`}
          ></span>
        ))}
      </div>
            ...
            {[
              ...
              <div key={index} className="w-full flex justify-center">
                <img
                  ...
                  onClick={() =>
                    (window.location.href = `/books/book${index + 1}`)
                  }
                  onError={(e) => {
